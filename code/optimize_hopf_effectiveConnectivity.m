%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% HOPF MODEL OPTIMISATION - use of Effective Connectivity (EC) instead of SC
%
% Written by 
% Gustavo Deco
% Edited by
...
% - ksdist: the Kolmogorov-Smirnov distance statistic between empirical and
% simulated data 
...
% - Coptim: 
%       effective connectivity  (EC) for the global coupling factor, derived from 
...
load ../data/meanSCs/sc_dbs80.mat;
C=sc;
C=C/max(max(C))*0.2;
...
save ../results/hopf_model/optimizedhopf_K_EC.mat WE PTRsimul Pstatessimul metastability ksdist klpstates kldist_pms entropydist_pms fitt Coptim NSUB f_diff;
