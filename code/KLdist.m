...
% Used to compute the Kullback-Leibler (KL) distance, and symmetrize it. 
% This parameter is used to check for the fitting of the simulated and the 
% empirical PMS (Probabilistic Metastable Substates) spaces.
ns=size(TRANS_1,1);
EMIS_1  = eye(ns);
EMIS_2  = eye(ns);
...
% Check ergodicity:
% ergodicity: property of a system to have the same behavior averaged over 
...
T = 1000000; 
% hmmgenerate: 
% matlab method to generate a sequence for a Hidden Markov Model
...
% hmmdecode: calculate the posterior state probabilities of a sequence
