function [PTRANSITION,Pstates] = LEiDA_fix_clusterNew(BOLD,NumClusters,Center,TR)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
Leading_Eig=zeros(Tmax,2*N_areas); % All leading eigenvectors
...
% Calculating the distance between Leading Eigenvectors and the Centroids
for t=1:t_all
    for j=1:NumClusters
