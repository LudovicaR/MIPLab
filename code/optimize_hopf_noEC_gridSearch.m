...
% to reduce the computational cost, take only 5 subjects from empirial data
...
%% Saving
save optimizedhopf_grid.mat WE PTRsimul Pstatessimul metastability ksdist klpstates kldist_pms entropydist_pms fitt NSUB f_diff FCsim FCemp;

save HopfModel_results_grid.mat;
